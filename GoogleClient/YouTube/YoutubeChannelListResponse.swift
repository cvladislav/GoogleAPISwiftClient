//
//  YoutubeChannelListResponse.swift
...
open class YoutubeChannelListResponse: GoogleObjectList {
	public typealias `Type` = YoutubeChannel
	/// A list of channels that match the request criteria.
	open var items: [Type]!
	open var tokenPagination: YoutubeTokenPagination!
	/// Identifies what kind of resource this is. Value: the fixed string "youtube#channelListResponse".
	open var kind: String = "youtube#channelListResponse"
