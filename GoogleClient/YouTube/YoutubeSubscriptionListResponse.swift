...
open class YoutubeSubscriptionListResponse: GoogleObjectList {
	public typealias `Type` = YoutubeSubscription
	/// A list of subscriptions that match the request criteria.
	open var items: [Type]!
	open var tokenPagination: YoutubeTokenPagination!
	/// Identifies what kind of resource this is. Value: the fixed string "youtube#subscriptionListResponse".
	open var kind: String = "youtube#subscriptionListResponse"
