...
open class YoutubeVideoStatus: ObjectType {
	/// The video's privacy status.
	open var privacyStatus: YoutubeVideoStatusPrivacyStatus!
	/// This value indicates if the video can be embedded on another website.
	open var embeddable: Bool!
	/// This value indicates if the extended video statistics on the watch page can be viewed by everyone. Note that the view count, likes, etc will still be visible if this is disabled.
	open var publicStatsViewable: Bool!
	/// The video's license.
	open var license: YoutubeVideoStatusLicense!
	/// This value explains why a video failed to upload. This property is only present if the uploadStatus property indicates that the upload failed.
	open var failureReason: YoutubeVideoStatusFailureReason!
	/// This value explains why YouTube rejected an uploaded video. This property is only present if the uploadStatus property indicates that the upload was rejected.
	open var rejectionReason: YoutubeVideoStatusRejectionReason!
	/// The status of the uploaded video.
	open var uploadStatus: YoutubeVideoStatusUploadStatus!
