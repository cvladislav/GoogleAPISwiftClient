//
//  YoutubePlaylistItemListResponse.swift
...
open class YoutubePlaylistItemListResponse: GoogleObjectList {
	public typealias `Type` = YoutubePlaylistItem
	/// A list of playlist items that match the request criteria.
	open var items: [Type]!
	open var tokenPagination: YoutubeTokenPagination!
	/// Identifies what kind of resource this is. Value: the fixed string "youtube#playlistItemListResponse".
	open var kind: String = "youtube#playlistItemListResponse"
